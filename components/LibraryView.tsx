            ...
            {recentlyPlayed.map(song => (
              ...
              >
                <div className="relative aspect-square rounded-xl overflow-hidden mb-2">
                  <img src={song.coverUrl === 'default-vinyl' ? 'https://picsum.photos/seed/vinyl/400/400' : song.coverUrl} alt={song.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
